...
export const actualIncommingCPO = () => {
    ...
    const versus = [
        ...
        <div class="flex gap-1">
            <div class="flex flex-col-reverse items-end w-full text-cyan-500 font-bold bg-black p-2 rounded-lg"><span class="text-[0.6vw]">QTY (in Tons)</span><span class="text-amber-500 text-[0.9vw]">48,380.00</span></div>
