        ...
        <div class="flex flex-col w-full">
            <div class="flex items-center gap-6">
                ...
                <router-link
                    ...
                    :to="load.link"
                    class="p-4 w-[30px] h-[30px] cursor-pointer bg-transparent text-emerald-500 rotate-180 hover:rotate-[-180] hover:bg-black hover:text-amber-500 rounded-full flex items-center justify-center transition-all duration-500"
                >
