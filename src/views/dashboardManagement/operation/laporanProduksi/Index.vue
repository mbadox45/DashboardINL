...
const submitData = async () => {
    if (formData.value.pmg_id != null && formData.value.tanggal != null && formData.value.item_produksi_id != null && formData.value.qty != null) {
    ...
    <div class="flex flex-col w-full gap-8">
        ...
        <Card>
            ...
            <template #content>
                ...
                <ScrollPanel v-else style="width: 100%; height: 30vw">
                                ...
                                <Panel v-for="(items, dex) in item.items" :key="dex" :toggleable="items.detail.length > 0 ? true : false" :collapsed="true">
                                    ...
                                    <div class="w-full">
                                        <DataTable :value="items.detail" showGridlines dataKey="id">
                                            ...
                                            <Column field="item_produksi" sortable header="Item" style="width: 25%; font-size: 0.8vw" headerStyle="background-color:rgb(251 207 232); color:black">
                                                <template #body="{ data }">
                                                    <div class="flex w-full font-bold">
                                            ...
                                            <Column field="pmg" header="PMG" style="width: 25%; font-size: 0.8vw" headerStyle="background-color:rgb(251 207 232); color:black">
                                                <template #body="{ data }">
                                                    <div class="flex w-full font-bold">
                                            ...
                                            <Column field="qty" sortable header="Jumlah (Kg)" style="width: 25%; font-size: 0.8vw" headerStyle="background-color:rgb(251 207 232); color:black">
                                                <template #body="{ data }">
