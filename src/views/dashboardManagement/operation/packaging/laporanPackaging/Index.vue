...
const submitData = async () => {
    if (!formData.value.packaging_id || !formData.value.tanggal || !formData.value.item_packaging_id || !formData.value.qty) {
                                ...
                                <Panel v-for="(items, dex) in item.items" :key="dex" :toggleable="items.detail.length > 0 ? true : false" :collapsed="true">
                                    ...
                                    <div class="w-full">
                                        <DataTable :value="items.detail" showGridlines dataKey="id">
                                            ...
                                            <Column field="item_packaging_id" sortable header="Jenis" style="width: 25%; font-size: 0.8vw">
                                                <template #body="{ data }">
                                                    <div class="flex w-full font-bold">
                                            ...
                                            <Column field="packaging" header="Lokasi Packaging" style="width: 25%; font-size: 0.8vw">
                                                <template #body="{ data }">
                                                    <div class="flex w-full font-bold">
