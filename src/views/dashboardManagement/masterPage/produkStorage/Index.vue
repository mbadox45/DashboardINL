...
import { listJenis } from '@/controller/getApiFromThisApp/dummy/variableDummy';
...
const loadData = async () => {
    try {
        const data = await productStorageScmController.getAll();
...
<template>
    <div class="flex flex-col w-full gap-8">
        <div class="flex gap-2 items-center justify-between w-full font-bold">
            <span class="text-3xl">Master Product Storage</span>
