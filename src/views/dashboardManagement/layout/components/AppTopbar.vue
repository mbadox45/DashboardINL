        ...
        <div class="layout-topbar-actions">
            ...
            <Popover ref="op">
                <div class="flex flex-col items-center gap-4 w-[25rem] py-2">
                    <span class="opacity-40 text-[0.6vw] pb-3 border-b w-full text-center">Management Dashboard INL Edge</span>
                    <i class="pi pi-user p-6 rounded-full bg-slate-200 w-auto" style="font-size: 3vw"></i>
                    <div class="flex flex-col items-center font-bold">
                        <span class="text-[0.9vw] uppercase">{{ users.name }}</span>
                        <span class="text-[0.7vw] font-light">{{ users.jabatan }}</span>
                        <span class="text-[0.7vw] capitalize font-mono font-light">{{ roles }}</span>
                    </div>
                    <button @click="signOut" class="py-2 px-6 w-full flex gap-3 items-center justify-center rounded-lg shadow shadow-gray-700 hover:bg-red-700 transition-all duration-300 text-white bg-red-600">
                        <i class="pi pi-sign-out"></i><span>Exit Session</span>
                    </button>
                </div>
            </Popover>
        </div>
