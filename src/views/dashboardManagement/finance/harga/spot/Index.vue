...
const exportToExcel = () => {
    ...
    const exportData = listTable.value.map((item) => ({
        ...
        'Spot (Kg)': Number(item.spot).toFixed(2),
        Kurs: Number(item.kurs).toFixed(2),
        'Harga Spot (MT) Asing': Number(item.hargaAsingSpot).toFixed(2)
    }));
    ...
    saveAs(data, `Data-Harga-Spot-${moment().format('YYYY-MM-DD-HHmmss')}.xlsx`);
};
        ...
        <Drawer v-model:visible="drawerCond" position="right" class="!w-full md:!w-[30rem]">
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <DatePicker v-model="formData.tanggal" dateFormat="yy-mm-dd" showIcon placeholder="Please input Date" :maxDate="maxDate" showButtonBar :manualInput="false" />
                </div>
                <div class="flex flex-col gap-1">
